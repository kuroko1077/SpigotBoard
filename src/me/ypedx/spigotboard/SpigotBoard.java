...
public class SpigotBoard extends JavaPlugin {
    ...
    public void onEnable(){
        ...
        if(configValues.getUpdateCheckerStatus()){
            ...
            startUpdateTask(settings.getUpdateInterval());
        }
    ...
    private void registerEvents(){
        ...
        pm.registerEvents(new DEvent(this), this);
    }
    ...
    public void startUpdateTask(double interval){
        scoreboardTaskID = new ScoreboardTask(this).runTaskTimerAsynchronously(this, 0, (long) (interval * 20.0)).getTaskId();
    }
